...
<head>
    ...
    <link rel="stylesheet" href="../../../timetable.js-master/dist/styles/timetablejs.css">
    <link rel="stylesheet" href="../../../timetable.js-master/dist/styles/demo.css">
...
<div class="site-wrap">
                ...
                <div class="mr-auto">
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <li>
                                <a href="#" class="nav-link text-left">Emploi du Temps</a>
                            </li>
                            <li>
                                <a href="#" class="nav-link text-left">Devoirs</a>
                            </li>
                        </ul>
                    </nav>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <script src="../../../timetable.js-master/dist/scripts/timetable.js"></script>
            ...
            <script>
                ...
                /*timetable.addEvent('Sightseeing', 'Rotterdam', new Date(2015,7,17,9,0o0), new Date(2015,7,17,11,30), { url: '#' });
                ...
                timetable.addEvent('Cocktails', 'Rotterdam', new Date(2015,7,18,0o0,0o0), new Date(2015,7,18,0o2,0o0), { class: 'vip-only' });*/
