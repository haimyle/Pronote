...
<div class="site-wrap">
                        ...
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                    <li class="has-children"><a href="#">Planning</a>
                                        <ul class="dropdown">
                                            <li><a href="create.php">Créer planning</a></li>
                                            <li><a href="update.php">Modifier planning</a></li>
                                            <li><a href="delete.php">Supprimer planning</a></li>
                                        </ul>
                                    </li>
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li><a href="#">Inscrire compte</a></li>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../../../assets/academics-master/images/bg_1.jpg')">
        <div class="container">
            <div class="row align-items-end justify-content-center text-center">
                <div class="col-lg-7">
                    <h2 class="mb-0">Créer Planning</h2>
                    <p></p>
                </div>
            </div>
        </div>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <form method="post" action="../../traitement/planning/traitementCreate.php">
