...
<head>
  ...
  <link rel="stylesheet" href="../../../assets/schedule-template-master/assets/css/style.css">
  <title>Emploi du Temps</title>
</head>
<body>
  <header class="cd-main-header text-center flex flex-column flex-center">
    <p class="margin-top-xxxxs margin-bottom-md"></a></p>

    <h1 class="text-xl">Emploi du Temps</h1>
  </header>
      ...
      <ul>
        <li class="cd-schedule__group">
          ...
          <ul>
              ...
              <?php
              $req = $bdd->getBdd()->query('SELECT bloc_heure.*, matiere.matiere FROM bloc_heure INNER JOIN matiere ON bloc_heure.ref_matiere=matiere.id_matiere WHERE date="Lundi"');
              while($res=$req->fetch()){
                  ?>
                      <a data-start="<?php echo $res['heure_debut'];?>" data-end="<?php echo $res['heure_fin'];?>" data-content="#" data-event="#" href="#0">
                          <em class="cd-schedule__name"><?php echo $res['matiere'];?></em>
                      </a>
              <?php } ?>
              </li>
            <!--li class="cd-schedule__event">
  ...
  <script src="../../../assets/schedule-template-master/assets/js/util.js"></script> <!-- util functions included in the CodyHouse framework -->
  <script src="../../../assets/schedule-template-master/assets/js/main.js"></script>
</body>
</html>