...
<div class="site-wrap">
                ...
                <div class="mr-auto">
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            <li>
                                <a href="../admin/homepage.php" class="nav-link text-left">Accueil</a>
                            </li>
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li><a href="../professeur/.php">Inscrire compte</a></li>
                                    <li><a href="../professeur/.php">Modifier compte</a></li>
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                    <li><a href="read.php">Liste des étudiants</a></li>
                                    <li><a href="create.php">Inscrire compte</a></li>
                                    <li><a href="update.php">Modifier compte</a></li>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../../../assets/academics-master/images/bg_1.jpg')">
        <div class="container">
            <div class="row align-items-end justify-content-center text-center">
                <div class="col-lg-7">
                    <h2 class="mb-0">Modification de Compte Etudiant</h2>
                    <p></p>
                </div>
            </div>
        </div>
    ...
    <div class="custom-breadcrumns border-bottom">
        <div class="container">
            ...
            <span class="current">Gestion Etudiant</span>
        </div>
    </div>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <form method="post" action="../../traitement/etudiant/traitementUpdate.php">
                <div class="row justify-content-center">
                    ...
                    <table id="myTable" class="display">
                        ...
                        <tbody>
                        <?php
                        $req = $bdd->getBdd()->query('SELECT etudiant.*, classe.classe FROM etudiant INNER JOIN classe ON etudiant.ref_classe = classe.id_classe');
                        while ($res = $req->fetch()) {
                            ?>
                            <tr>
                                <td><?php echo $res['id_etudiant']; ?></td>
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label for="id_professeur">ID Etudiant</label>
                                <select class="form-control" name="id_etudiant" id="id_etudiant">
                                    <option></option>
                                    <?php
                                    $req = $bdd->getBdd()->query('SELECT * FROM etudiant');
                                    while($res=$req->fetch()){
                                        ?>
                                        <option value="<?php echo $res['id_etudiant'];?>"><?php echo $res['id_etudiant'].". ".$res['prenom']." ".$res['nom']." ";?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="col-md-12 form-group">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <select class="form-control" name="id_classe" id="id_classe" required>
                                    ...
                                    while($res=$req->fetch()){
                                        ?>
                                        <option value="<?php echo $res['id_classe'];?>"><?php echo $res['id_classe'].". ".$res['classe'];?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="col-md-12 form-group">
