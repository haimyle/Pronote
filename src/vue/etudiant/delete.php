...
<div class="site-wrap">
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../../../assets/academics-master/images/bg_1.jpg')">
        <div class="container">
            <div class="row align-items-end justify-content-center text-center">
                <div class="col-lg-7">
                    <h2 class="mb-0">Suppression de Compte Etudiant</h2>
                    <p></p>
                </div>
            </div>
        </div>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <form method="post" action="../../traitement/etudiant/traitementDelete.php">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <select class="form-control" name="id_professeur" id="id_professeur">
                                    ...
                                    while($res=$req->fetch()){
                                        ?>
                                        <option value="<?php echo $res['id_etudiant'];?>"><?php echo $res['id_etudiant'].". ".$res['prenom']." ".$res['nom']." - Classe: ".$res['classe'];?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
