        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 text-right">
                    <a href="role.php" class="small mr-3"><span class="icon-unlock-alt"></span> Se Connecter</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="col-md-12 form-group">
                        <label for="pword">Vous êtes : </label>
                    </div>
                    <div class="row">
                        <div class="col-md-12 btn-group-vertical">
                            <a href="professeur/login.php" class="btn btn-primary btn-lg px-5">Administrateur</a>
                            <p></p>
                        </div>
                        <div class="col-md-12 btn-group-vertical">
                            <a href="professeur/login.php" class="btn btn-primary btn-lg px-5">Enseignant(e)</a>
                            <p></p>
                        </div>
                        <div class="col-md-12 btn-group-vertical">
                            <a href="etudiant/login.php" class="btn btn-primary btn-lg px-5">Étudiant(e)</a>
                            <p></p>
                        </div>
                    </div>
                </div>
