...
<div class="site-wrap">
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../../../assets/academics-master/images/bg_1.jpg')">
        <div class="container">
            <div class="row align-items-end justify-content-center text-center">
                <div class="col-lg-7">
                    <h2 class="mb-0">Creer un Devoir</h2>
                    <p></p>
                </div>
            </div>
        </div>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <form method="post" action="../../traitement/devoir/traitementCreate.php">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea id="recapitulatif" name="recapitulatif" class="form-control form-control-lg"></textarea>
                            </div>
                            <div class="col-md-12 form-group">
