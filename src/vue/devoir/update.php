...
<div class="site-wrap">
                    ...
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                    <li class="has-children"><a href="#">Devoir</a>
                                        <ul class="dropdown">
                                            <li><a href="../devoir/create.php">Créer devoir</a></li>
                                            <li><a href="../devoir/update.php">Modifier devoir</a></li>
                                            <li><a href="../devoir/delete.php">Supprimer devoir</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../../../assets/academics-master/images/bg_1.jpg')">
        <div class="container">
            <div class="row align-items-end justify-content-center text-center">
                <div class="col-lg-7">
                    <h2 class="mb-0">Supprimer un Devoir</h2>
                    <p></p>
                </div>
            </div>
        </div>
    ...
    <div class="custom-breadcrumns border-bottom">
        <div class="container">
            ...
            <span class="current">Gestion Devoirs</span>
        </div>
    </div>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <form method="post" action="../../traitement/devoir/traitementUpdate.php">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-md-12 form-group">
                            <?php
                            if(isset($_POST['id_devoir'])&&$_POST['id_devoir']!=""){
                                    $req = $bdd->getBdd()->prepare('SELECT * FROM devoir WHERE id_devoir = :id_devoir ');
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text"  value="<?php echo $res['titre'];?>" name="titre" class="form-control form-control-lg">
                                    </div>
                                    <div class="col-md-12 form-group">
                                        <label for="recapitulatif">Recapitulatif</label>
                                        <textarea id="recapitulatif" name="recapitulatif" class="form-control form-control-lg"><?php echo $res['recapitulatif'];?></textarea>
                                    </div>
                                    <div class="col-md-12 form-group">
                                        <label for="classe">Classe</label>
                                        <select class="form-control" name="classe" id="classe">
                                            <option value="<?php echo $res['ref_classe'];?>" selected><?php echo $res['ref_classe'];?></option>
                                            <?php
                                            $req = $bdd->getBdd()->prepare
                                            ('SELECT cp.*, c.classe 
                                                FROM classeprofesseur AS cp  
                                                INNER JOIN classe AS c 
                                                ON cp.ref_classe = c.id_classe
                                                WHERE cp.ref_professeur = :ref_professeur ');
                                            $req->execute(array(
                                                'ref_professeur' => $_SESSION['id']
                                            ));
                                            while ($res=$req->fetch()){
                                                ?>
                                                <option value="<?php echo $res['ref_classe'];?>"><?php echo $res['ref_classe'].". ".$res['classe'];?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="col-md-12 form-group">
                                        <label for="deadline">Deadline</label>
                                        <?php $deadline = (new DateTime($res['deadline']))->format('Y-m-d'); ?>
                                        <input type="date" value="<?php echo $deadline;?>" name="deadline" class="form-control form-control-lg" required>
                                    </div>
                                    <div class="col-12">
                            ...
                            <?php } ?>
                            <?php } else {
                                echo "<script>alert('Veuillez choisir un ID Devoir');
                                window.location.href='../../vue/devoir/choisirID.php';</script>";
