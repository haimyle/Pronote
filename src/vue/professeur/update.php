...
<div class="site-wrap">
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../../../assets/academics-master/images/bg_1.jpg')">
        <div class="container">
            <div class="row align-items-end justify-content-center text-center">
                <div class="col-lg-7">
                    <h2 class="mb-0">Modification de Compte Enseignants</h2>
                    <p></p>
                </div>
            </div>
        </div>
    ...
    <div class="site-section">
        <div class="container">
            ...
            <form method="post" action="../../traitement/professeur/traitementUpdate.php">
                    ...
                    <div class="col-lg-12 mx-auto text-left">
                        <table id="myTable" class="display">
                            ...
                            while ($res = $req->fetch()) {
                                ?>
                                <tr>
                                    <td><?php echo $res['id_professeur']; ?></td>
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label for="id_professeur">ID Enseignant</label>
                                <select class="form-control" name="id_professeur" id="id_professeur">
                                    <option></option>
                                    <?php
                                    $req = $bdd->getBdd()->query('SELECT * FROM professeur');
                                    while($res=$req->fetch()){
                                        ?>
