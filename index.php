...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-3 text-right">
            <a href="src/vue/role.php" class="small mr-3"><span class="icon-unlock-alt"></span> Se Connecter</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('assets/academics-master/images/hero_1.jpg');">
        <div class="container">
          <div class="row align-items-center">
    ...
    <div class="section-bg style-1" style="background-image: url('assets/academics-master/images/about_1.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
    ...
    <div class="section-bg style-1" style="background-image: url('assets/academics-master/images/hero_1.jpg');">
      <div class="container">
        <div class="row">
