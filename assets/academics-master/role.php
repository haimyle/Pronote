        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 text-right">
                    <a href="login.html" class="small mr-3"><span class="icon-unlock-alt"></span> Se Connecter</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="col-md-12 btn-group-vertical">
                            <a href="login_prof.php" class="btn btn-primary btn-lg px-5">Administrateur</a>
                            <p></p>
                        </div>
                        <div class="col-md-12 btn-group-vertical">
                            <a href="login_prof.php" class="btn btn-primary btn-lg px-5">Enseignant(e)</a>
                            <p></p>
                        </div>
                        <div class="col-md-12 btn-group-vertical">
                            <a href="connectionEtudiant.php" class="btn btn-primary btn-lg px-5">Étudiant(e)</a>
                            <p></p>
                        </div>
                    </div>
                </div>
